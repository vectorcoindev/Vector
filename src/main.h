...
inline bool IsProtocolV3(int64_t nTime) { return TestNet() || nTime > 1478531200; }

inline int64_t FutureDriftV1(int64_t nTime) { return nTime + 10 * 60; }
inline int64_t FutureDriftV2(int64_t nTime) { return nTime + 3 * 60; }
 ...
 * of the block.
 *
 * Blocks are appended to VEC0001.dat files on disk.  Their location on disk
